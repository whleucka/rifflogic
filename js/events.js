...
export const TAB_TRACK_CHANGE = 'tab:track-change';
export const TAB_PLAY = 'tab:play';
export const TAB_PAUSE = 'tab:pause';
...
export const TAB_TEMPO = 'tab:tempo';
export const TAB_LOOP = 'tab:loop';
